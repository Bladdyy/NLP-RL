...
def deterministic_actor_step(actor, training_state, env, env_state, extra_fields):
...
def multi_sample_actor_step(actor, training_state, env, env_state, key, K, args, sa_encoder, g_encoder, extra_fields):
